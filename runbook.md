...
- 已在 iPhone 15 / iOS 17.5 Simulator 執行 18 個 unit/integration tests，0 failures，結果為 `TEST SUCCEEDED`；另有 10 個 XCUITests 由同一個 shared scheme 執行。
...
- 完整 suite 共 18 個 unit/integration tests 與 10 個 XCUITests，0 failures。
